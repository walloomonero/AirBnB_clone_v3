...
def state_create():
    """
    To create state route
    :return: The newly created state obj
    """
...
def state_by_id(state_id):
    """
    To get a specific State object by ID
...
def state_put(state_id):
    """
    To update specific State object by ID
    :parameter state_id: state object ID
    :return: The state object and 200 on success, or 400 or 404 on failure
    """
    state_json = request.get_json(silent=True)
    if state_json is None:
        abort(400, 'Not a JSON')
