...
def amenity_get_all():
    """
    To retrieve all Amenity objects
    :return: The json of all states
    """
    am_list = []
...
def amenity_create():
    """
    To create amenity route
    :return: The newly created amenity obj
    """
...
def amenity_by_id(amenity_id):
    """
    To get a specific Amenity object by ID
...
def amenity_put(amenity_id):
    """
    To update specific Amenity object by ID
    :param amenity_id: amenity object ID
    :return: The amenity object and 200 on success, or 400 or 404 on failure
    """
    am_json = request.get_json(silent=True)
    if am_json is None:
        abort(400, 'Not a JSON')
