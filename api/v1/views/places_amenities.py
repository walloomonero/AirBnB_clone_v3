...
def amenity_by_place(place_id):
    """
    To get all amenities of a place
    :parameter place_id: amenity id
...
def unlink_amenity_from_place(place_id, amenity_id):
    """
    To unlink an amenity in a place
    :parameter place_id: place id
    :parameter amenity_id: amenity id
    :return: The empty dict or error
    """
...
def link_amenity_to_place(place_id, amenity_id):
    """
    To link a amenity with a place
    :parameter place_id: place id
    :parameter amenity_id: amenity id
    :return: The Amenity obj added or error
    """
